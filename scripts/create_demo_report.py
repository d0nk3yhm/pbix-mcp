...
if __name__ == "__main__":
    ...
    print("\nContents:")
    print("  - Template: financials table (Segment, Country, Product, Sales, Profit, etc.)")
    print("  - 10 custom DAX measures (Revenue, Profit, Margin, Units, etc.)")
    print("  - 2 pages: Financial Overview (8 visuals), Regional Analysis (3 visuals)")
